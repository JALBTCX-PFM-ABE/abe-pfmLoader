...
if [ $SYS = "Linux" ]; then
    ...
    LIBRARIES="-L $PFM_LIB -lgsf -lllz -lCZMIL -lCHARTS -lchrtr2 -lbag -lbeecrypt -lhdf5 -lBinaryFeatureData -lnvutility -lpfm -llas -lproj -lgdal -lxml2 -lpoppler -lwsock32 -liconv"
